...
```{r oxygenation}
measurements <- readxl::read_excel("all-measurements-part1-2020-07-17-1044.xlsx") %>%
  bind_rows(readxl::read_excel("all-measurements-part2-2020-07-17-1045.xlsx")) %>%
...
ggsave("../output/plot-clinical-sfratio-bar-stack.png",w = 15, h = 10)
```
